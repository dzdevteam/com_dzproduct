 ...
 */
class DzproductViewRelations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		DzproductHelper::addSubmenu('relations');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_DZPRODUCT_TITLE_RELATIONS'), 'relations.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_dzproduct&view=relations');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_DZPRODUCT_RELATIONS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_DZPRODUCT_RELATIONS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_DZPRODUCT_RELATIONS_CREATED_BY'),
		'a.catid' => JText::_('COM_DZPRODUCT_RELATIONS_CATID'),
		'a.groupid' => JText::_('COM_DZPRODUCT_RELATIONS_GROUPID'),
		);
	}
