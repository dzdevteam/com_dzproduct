...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_dzproduct&task=groups.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_dzproduct&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="groupList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_DZPRODUCT_GROUPS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_dzproduct&task=group.edit&id='.(int) $item->id); ?>">
