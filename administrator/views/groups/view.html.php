 ...
 */
class DzproductViewGroups extends JViewLegacy
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        DzproductHelper::addSubmenu('groups');
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_DZPRODUCT_TITLE_GROUPS'), 'groups.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_dzproduct&view=groups');
    ...
    protected function getSortFields()
    {
        ...
        'a.name' => JText::_('COM_DZPRODUCT_GROUPS_NAME'),
        'a.fields' => JText::_('COM_DZPRODUCT_GROUPS_FIELDS'),
        'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
        'a.state' => JText::_('JSTATUS'),
        'a.checked_out' => JText::_('COM_DZPRODUCT_GROUPS_CHECKED_OUT'),
        'a.checked_out_time' => JText::_('COM_DZPRODUCT_GROUPS_CHECKED_OUT_TIME'),
        'a.created_by' => JText::_('COM_DZPRODUCT_GROUPS_CREATED_BY'),
        'a.icon' => JText::_('COM_DZPRODUCT_GROUPS_ICON'),
        );
    }
