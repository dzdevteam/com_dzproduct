...
?>
<form action="<?php echo JRoute::_('index.php?option=com_dzproduct&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
        ...
        <table class="table table-striped" id="itemList">
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
                    <td class="center">
                        <?php echo JHtml::_('productadministrator.published', $item->state, $i, 'orders.', $canChange, 'cb'); ?>
                    </td>
                <?php endif; ?>
                <td>
                ...
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_dzproduct&task=order.edit&id='.(int) $item->id); ?>">
