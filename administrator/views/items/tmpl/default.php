...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_dzproduct&task=items.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_dzproduct&view=items'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="itemList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_dzproduct&task=item.edit&id='.(int) $item->id); ?>">
