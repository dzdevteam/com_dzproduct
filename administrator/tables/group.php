 ...
 * group Table class
 */
class DzproductTablegroup extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__dzproduct_groups', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_dzproduct.group.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_dzproduct','group');
            $default_actions = JFactory::getACL()->getAssetRules('com_dzproduct.group.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_dzproduct.group.' . (int) $this->$k;
    }
