...
/**
 * fielddata Table class
 */
class DzproductTablefielddata extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__dzproduct_field_data', 'id', $db);
    }
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_dzproduct.fielddata.' . (int) $this->$k;
    }
